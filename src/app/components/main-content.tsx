    ...
    <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center justify-between gap-12 px-4 py-8 md:px-12">
      ...
      <div className="flex flex-col gap-12">
        <form
          ...
          className="mx-auto flex w-[700px] items-center justify-between gap-2 rounded-xl border border-zinc-500 px-6 py-3"
        >
          <input
            type="text"
            placeholder="Cole a URL"
            className="w-[600px] rounded-md bg-zinc-800 px-4 py-3 font-semibold outline-0"
            value={url}
            onChange={(e) => setUrl(e.target.value)}
          />
          <button
            type="submit"
            className="rounded-md bg-zinc-200 px-4 py-3 text-lg font-semibold text-zinc-950 transition-colors hover:bg-zinc-300"
          >
            Resumer
          </button>
        </form>
        <div>
          {article && (
            <div className="h-[400px] w-[700px] overflow-y-auto rounded-md bg-zinc-800 px-6 py-4 font-semibold outline-0">
